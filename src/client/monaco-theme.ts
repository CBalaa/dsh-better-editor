...
function themeData(dark: boolean): Record<string, unknown> {
  ...
  return {
    ...
    colors: {
      ...
      'editor.lineHighlightBackground': dark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)',
      'editor.selectionBackground': dark ? 'rgba(255,255,255,0.22)' : 'rgba(0,0,0,0.12)',
      'editor.inactiveSelectionBackground': dark ? 'rgba(255,255,255,0.11)' : 'rgba(0,0,0,0.06)',
      ...
      'scrollbarSlider.background': dark ? 'rgba(121,121,121,0.4)' : 'rgba(100,100,100,0.4)',
      'scrollbarSlider.hoverBackground': dark ? 'rgba(100,100,100,0.7)' : 'rgba(100,100,100,0.7)',
      'scrollbarSlider.activeBackground': dark ? 'rgba(191,191,191,0.4)' : 'rgba(0,0,0,0.6)',
    },
  }
}
